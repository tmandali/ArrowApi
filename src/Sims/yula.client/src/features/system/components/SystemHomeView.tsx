 ...
 * Kapatma (X) butonu aktif kalır; tıklandığında veya Escape ile oturumun
 * hedef ekranına yönlendirerek yan dock moduna geçiş sağlar.
 * AppHeader üzerinden veya Cmd+K ile tetiklenen arama açıkken WorkspaceSearchMainView tam sayfa render edilir.
 */
