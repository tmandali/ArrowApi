...
async function doIndexReportSchemas(): Promise<number> {
  ...
  pending.push(
    ...
    },
    {
      id: "my_skills",
      scope: "my",
      content: "Beceriler & Komutlar (/my/skills): Kullanıcı tanımlı slash komutları ve becerileri (skills) yönetilir.",
    ...
    },
    {
      id: "my_agents",
      scope: "my",
      content: "Personalar & Ajanlar (/my/agents): Kullanıcı tanımlı alt ajanlar ve sistem personalları yapılandırılır ve yönetilir.",
    ...
    },
    {
      id: "my_plugins",
      scope: "my",
      content: "Kurumsal Eklentiler (/my/plugins): Sisteme entegre edilen Python AI sidecar, DuckDB ve ileri analitik araç eklentileri listelenir.",
    ...
    },
    {
      id: "my_memory",
      scope: "my",
      content: "Kalıcı Bellek & Tercihler (/my/memory): Yula AI kalıcı hafızası (agent memory) ve kullanıcı tercihleri yönetilir.",
