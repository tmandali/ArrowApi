...
import type {
  RetailSalesColumn,
  RetailSalesGridRow,
} from "../services/retail-sales-arrow"

type RetailSalesResultGridProps = {
...
/** Flat Arrow result spreadsheet for Retail Sales. */
export function RetailSalesResultGrid({
  columns,
  rows,
  totalRows,
  showFilterRow = false,
