...
import { hookPipeline } from '../extensions/hooks';
import { executionCoordinator } from '../runtime/execution-queue';
import { telemetryTracker } from '../telemetry/telemetry-metrics';
import { truncateContent } from '../compaction/truncate';
import { globalMutationLine } from '../runtime/mutation-line';
import { agentMemory } from '../session/memory';
import { playbookManager } from '../knowledge/playbook';
import { sessionManager } from '../session/session-branch';
...
import { skillsManager } from '../knowledge/skills';
import { i18nManager } from '../extensions/i18n';
import { classifyDiagnosticError, type DiagnosticVerdict } from '../telemetry/diagnostic-triage';
