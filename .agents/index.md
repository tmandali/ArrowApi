...
| **Architecture (ADR)** | [Client Pyodide Skills](file:///Users/tmr/Source/ArrowApi/.agents/architecture/client-pyodide-skills.md) | Working on client-side WebAssembly Python execution, SkillEventHub, custom user skills, or DuckDB-Pyodide bridging. |
...
| **Standards** | [Bounded Context & Menu Architecture](file:///Users/tmr/Source/ArrowApi/.agents/standards/bounded-context-menu-standard.md) | Structuring workspace menu items as 1:1 Bounded Contexts ($BC = Bounded\ Process + Bounded\ State$). |
| **Standards** | [Workspace Orchestration & Sagas](file:///Users/tmr/Source/ArrowApi/.agents/standards/workspace-orchestration-saga-standard.md) | Multi-Orchestrator & Saga Process Manager coordinating value streams across Bounded Contexts. |
